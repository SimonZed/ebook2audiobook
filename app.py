...
SML tags available:
    ...
    headless_group.add_argument(cli_options[5], action='store_true', type=str, help='''Path to the ebook file for conversion. Cannot be used when --ebooks_dir or --text is present.''')
