                ...
                with gr.Tabs(elem_id='gr_tabs') as gr_tabs:
                    ...
                    with gr.Tab('Audiobookshelf', elem_id='gr_tab_abs_params', elem_classes='gr-tab', visible=visible_gr_tab_abs_params) as gr_tab_abs_params:
                        ...
                        with gr.Row(elem_id='gr_row2_abs'):
                            ...
                            gr_abs_search_btn = gr.Button('🔍', elem_id='gr_abs_search_btn', elem_classes=['gr-abs-search-btn'], variant='', visible=True, interactive=True, scale=0, min_width=120)
            ...
            def _change_gr_audiobook_list(session_id:str, selected:str|None)->dict:
                try:
                    ...
                    if session and session.get('id', False):
                        ...
                        return gr.update(visible=visible), gr.update(value=Path(selected).name)
                except Exception as e:
