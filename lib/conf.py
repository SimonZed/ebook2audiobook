...
torch_matrix = {
    # CPU
    "cpu":       {"os": list(systems.values()), "arch": list(archs.values()), "base": "2.7.1", "last": "2.13.0", "codec": "0.13.0"},
    # CUDA
    ...
    "cu132":     {"os": [systems['LINUX'],systems['WINDOWS']], "arch": [archs['X86_64'], archs['AMD64'], archs['AARCH64']], "base": "2.7.1", "last": "2.13.0", "codec": "0.13.0"},
    # ROCm
